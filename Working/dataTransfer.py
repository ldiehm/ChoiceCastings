...
class Application:
    ...
    def write_date(self, sheet):
        ...
        bothDates = str(currentDate).split('|')
...
if __name__ == "__main__":
    ...
    app = Application(appName= "VS Stocking Summary Data Transfer", sourceFile= 'VS Report', sourceFileColumns= ["ICPROD", "Total On Hand","Consigned", "Required","WIP"], targetFile= 'Stocking Summary', targetFileColumns=["T&B     Part #", "Total Inv:  JBS & T&B", "VS Cons  On Hand", "Current Demand", "SumOfWIP", ], dateLocation = (1,1))
    app.run()